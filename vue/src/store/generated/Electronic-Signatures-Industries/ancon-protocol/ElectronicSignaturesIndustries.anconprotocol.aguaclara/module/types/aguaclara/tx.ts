...
export const protobufPackage =
  "ElectronicSignaturesIndustries.anconprotocol.aguaclara";
...
const baseMsgSendMetadataOwnership: object = {
  creator: "",
  portId: "",
  channelId: "",
};
...
export class MsgClientImpl implements Msg {
  ...
  SendMetadataOwnership(
    ...
    const promise = this.rpc.request(
      "ElectronicSignaturesIndustries.anconprotocol.aguaclara.Msg",
      "SendMetadataOwnership",
      data
    );
