...
const baseDIDWebRoute: object = {
  name: "",
  route: "",
  cid: "",
  didWebDeactivated: false,
  didIdentity: "",
};
...
export const DIDWebRoute = {
  ...
  fromJSON(object: any): DIDWebRoute {
    ...
    if (
      object.didWebDeactivated !== undefined &&
      object.didWebDeactivated !== null
    ) {
  ...
  toJSON(message: DIDWebRoute): unknown {
    ...
    message.cid !== undefined && (obj.cid = message.cid);
    message.didWebDeactivated !== undefined &&
      (obj.didWebDeactivated = message.didWebDeactivated);
    message.didIdentity !== undefined &&
      (obj.didIdentity = message.didIdentity);
    return obj;
  },
