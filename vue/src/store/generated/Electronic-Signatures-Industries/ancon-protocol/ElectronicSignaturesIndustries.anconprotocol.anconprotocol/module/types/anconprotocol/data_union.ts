...
export const DataSource = {
  ...
  fromJSON(object: any): DataSource {
    ...
    if (
      object.didIdentityOwner !== undefined &&
      object.didIdentityOwner !== null
    ) {
  ...
  toJSON(message: DataSource): unknown {
    ...
    message.didIdentityOwner !== undefined &&
      (obj.didIdentityOwner = message.didIdentityOwner);
    if (message.anchors) {
...
export const Pricing = {
  ...
  toJSON(message: Pricing): unknown {
    ...
    message.dataSourceRef !== undefined &&
      (obj.dataSourceRef = message.dataSourceRef);
    message.creator !== undefined && (obj.creator = message.creator);
    return obj;
  },
...
export const MsgAddDataSourceResponse = {
  ...
  decode(
    ...
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = {
      ...baseMsgAddDataSourceResponse,
    } as MsgAddDataSourceResponse;
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
  ...
  fromPartial(
    object: DeepPartial<MsgAddDataSourceResponse>
  ): MsgAddDataSourceResponse {
    const message = {
      ...baseMsgAddDataSourceResponse,
    } as MsgAddDataSourceResponse;
...
export const MsgRemoveDataSourceResponse = {
  ...
  decode(
    ...
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = {
      ...baseMsgRemoveDataSourceResponse,
    } as MsgRemoveDataSourceResponse;
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
  ...
  fromPartial(
    object: DeepPartial<MsgRemoveDataSourceResponse>
  ): MsgRemoveDataSourceResponse {
    const message = {
      ...baseMsgRemoveDataSourceResponse,
    } as MsgRemoveDataSourceResponse;
...
const baseMsgUpdateDataSource: object = {
  creator: "",
  cid: "",
  name: "",
  description: "",
...
export const MsgUpdateDataSourceResponse = {
  ...
  decode(
    ...
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = {
      ...baseMsgUpdateDataSourceResponse,
    } as MsgUpdateDataSourceResponse;
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
  ...
  fromPartial(
    object: DeepPartial<MsgUpdateDataSourceResponse>
  ): MsgUpdateDataSourceResponse {
    const message = {
      ...baseMsgUpdateDataSourceResponse,
    } as MsgUpdateDataSourceResponse;
...
export const MsgAddDataUnion = {
  ...
  toJSON(message: MsgAddDataUnion): unknown {
    const obj: any = {};
    message.dataUnion !== undefined &&
      (obj.dataUnion = message.dataUnion
        ? DataUnion.toJSON(message.dataUnion)
        : undefined);
    message.creator !== undefined && (obj.creator = message.creator);
    return obj;
  },
...
export const MsgAddDataUnionResponse = {
  ...
  decode(input: Reader | Uint8Array, length?: number): MsgAddDataUnionResponse {
    ...
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = {
      ...baseMsgAddDataUnionResponse,
    } as MsgAddDataUnionResponse;
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        default:
  ...
  fromPartial(
    _: DeepPartial<MsgAddDataUnionResponse>
...
export const MsgRemoveDataUnionResponse = {
  ...
  decode(
    ...
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = {
      ...baseMsgRemoveDataUnionResponse,
    } as MsgRemoveDataUnionResponse;
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        default:
  ...
  fromPartial(
    _: DeepPartial<MsgRemoveDataUnionResponse>
  ): MsgRemoveDataUnionResponse {
    const message = {
      ...baseMsgRemoveDataUnionResponse,
    } as MsgRemoveDataUnionResponse;
...
export const MsgUpdateDataUnionResponse = {
  ...
  decode(
    ...
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = {
      ...baseMsgUpdateDataUnionResponse,
    } as MsgUpdateDataUnionResponse;
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        default:
  ...
  fromPartial(
    _: DeepPartial<MsgUpdateDataUnionResponse>
  ): MsgUpdateDataUnionResponse {
    const message = {
      ...baseMsgUpdateDataUnionResponse,
    } as MsgUpdateDataUnionResponse;
