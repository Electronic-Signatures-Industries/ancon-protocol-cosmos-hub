...
const baseMsgCreateDIDOwner: object = {
  creator: "",
  owner: "",
  didKey: "",
  didWeb: "",
...
export const MsgCreateDIDOwnerResponse = {
  ...
  decode(
    input: Reader | Uint8Array,
    length?: number
  ): MsgCreateDIDOwnerResponse {
    const reader = input instanceof Uint8Array ? new Reader(input) : input;
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = {
      ...baseMsgCreateDIDOwnerResponse,
    } as MsgCreateDIDOwnerResponse;
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        default:
  ...
  fromPartial(
    _: DeepPartial<MsgCreateDIDOwnerResponse>
  ): MsgCreateDIDOwnerResponse {
    const message = {
      ...baseMsgCreateDIDOwnerResponse,
    } as MsgCreateDIDOwnerResponse;
...
const baseMsgGrantAttribute: object = {
  identity: "",
  actor: "",
  creator: "",
  validity: 0,
...
export const MsgGrantAttributeResponse = {
  ...
  decode(
    input: Reader | Uint8Array,
    length?: number
  ): MsgGrantAttributeResponse {
    const reader = input instanceof Uint8Array ? new Reader(input) : input;
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = {
      ...baseMsgGrantAttributeResponse,
    } as MsgGrantAttributeResponse;
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
  ...
  fromPartial(
    object: DeepPartial<MsgGrantAttributeResponse>
  ): MsgGrantAttributeResponse {
    const message = {
      ...baseMsgGrantAttributeResponse,
    } as MsgGrantAttributeResponse;
...
export interface Msg {
  ...
  /** GrantAttribute TODO */
  GrantAttribute(
    request: MsgGrantAttribute
  ): Promise<MsgGrantAttributeResponse>;
...
export class MsgClientImpl implements Msg {
  ...
  GrantAttribute(
    ...
    return promise.then((data) =>
      MsgGrantAttributeResponse.decode(new Reader(data))
    );
  }
