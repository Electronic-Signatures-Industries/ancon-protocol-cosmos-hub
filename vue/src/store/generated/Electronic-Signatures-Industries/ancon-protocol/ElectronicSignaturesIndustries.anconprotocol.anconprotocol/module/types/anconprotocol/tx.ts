...
export const protobufPackage =
  "ElectronicSignaturesIndustries.anconprotocol.anconprotocol";
...
export const MsgUpdateMetadataOwnership = {
  ...
  decode(
    ...
    const message = {
      ...baseMsgUpdateMetadataOwnership,
    } as MsgUpdateMetadataOwnership;
  ...
  fromJSON(object: any): MsgUpdateMetadataOwnership {
    ...
    if (
      object.recipientChainId !== undefined &&
      object.recipientChainId !== null
    ) {
  ...
  toJSON(message: MsgUpdateMetadataOwnership): unknown {
    ...
    message.currentChainId !== undefined &&
      (obj.currentChainId = message.currentChainId);
    message.recipientChainId !== undefined &&
      (obj.recipientChainId = message.recipientChainId);
  ...
  fromPartial(
    object: DeepPartial<MsgUpdateMetadataOwnership>
  ): MsgUpdateMetadataOwnership {
    const message = {
      ...baseMsgUpdateMetadataOwnership,
    } as MsgUpdateMetadataOwnership;
...
const baseMsgSchemaStore: object = {
  creator: "",
  path: "",
  codec: "",
  isJsonSchema: false,
...
export const MsgSchemaStore = {
  ...
  toJSON(message: MsgSchemaStore): unknown {
    ...
    message.isJsonSchema !== undefined &&
      (obj.isJsonSchema = message.isJsonSchema);
    return obj;
  },
...
export const MsgSchemaStoreResponse = {
  encode(
    message: MsgSchemaStoreResponse,
    writer: Writer = Writer.create()
  ): Writer {
    if (message.cid !== "") {
  ...
  fromPartial(
    object: DeepPartial<MsgSchemaStoreResponse>
...
const baseMsgUpdateMetadataOwnershipResponse: object = {
  metadataRef: "",
  packetRef: "",
};
...
export const MsgUpdateMetadataOwnershipResponse = {
  ...
  decode(
    ...
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = {
      ...baseMsgUpdateMetadataOwnershipResponse,
    } as MsgUpdateMetadataOwnershipResponse;
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
  ...
  toJSON(message: MsgUpdateMetadataOwnershipResponse): unknown {
    const obj: any = {};
    message.metadataRef !== undefined &&
      (obj.metadataRef = message.metadataRef);
    message.packetRef !== undefined && (obj.packetRef = message.packetRef);
    return obj;
  },

  fromPartial(
    object: DeepPartial<MsgUpdateMetadataOwnershipResponse>
  ): MsgUpdateMetadataOwnershipResponse {
    const message = {
      ...baseMsgUpdateMetadataOwnershipResponse,
    } as MsgUpdateMetadataOwnershipResponse;
...
const baseMsgRegisterRelay: object = {
  sender: "",
  chain: "",
  alg: "",
  pub: "",
...
export const MsgRegisterRelayResponse = {
  ...
  decode(
    input: Reader | Uint8Array,
    length?: number
  ): MsgRegisterRelayResponse {
    const reader = input instanceof Uint8Array ? new Reader(input) : input;
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = {
      ...baseMsgRegisterRelayResponse,
    } as MsgRegisterRelayResponse;
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
  ...
  fromPartial(
    object: DeepPartial<MsgRegisterRelayResponse>
  ): MsgRegisterRelayResponse {
    const message = {
      ...baseMsgRegisterRelayResponse,
    } as MsgRegisterRelayResponse;
...
export const MsgCreateDid = {
  ...
  toJSON(message: MsgCreateDid): unknown {
    ...
    message.publicKeyBytes !== undefined &&
      (obj.publicKeyBytes = base64FromBytes(
        message.publicKeyBytes !== undefined
...
export const MsgMintTrustedContent = {
  ...
  fromPartial(
    object: DeepPartial<MsgMintTrustedContent>
...
export const MsgMintTrustedContentResponse = {
  ...
  decode(
    input: Reader | Uint8Array,
    length?: number
  ): MsgMintTrustedContentResponse {
    const reader = input instanceof Uint8Array ? new Reader(input) : input;
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = {
      ...baseMsgMintTrustedContentResponse,
    } as MsgMintTrustedContentResponse;
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
  ...
  fromPartial(
    object: DeepPartial<MsgMintTrustedContentResponse>
  ): MsgMintTrustedContentResponse {
    const message = {
      ...baseMsgMintTrustedContentResponse,
    } as MsgMintTrustedContentResponse;
...
export const MsgSendCrossMintTrusted = {
  ...
  decode(input: Reader | Uint8Array, length?: number): MsgSendCrossMintTrusted {
    ...
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = {
      ...baseMsgSendCrossMintTrusted,
    } as MsgSendCrossMintTrusted;
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
  ...
  fromJSON(object: any): MsgSendCrossMintTrusted {
    ...
    if (
      object.metaTransaction !== undefined &&
      object.metaTransaction !== null
    ) {
    ...
    if (
      object.destinationDomain !== undefined &&
      object.destinationDomain !== null
    ) {
  ...
  toJSON(message: MsgSendCrossMintTrusted): unknown {
    ...
    message.lazyMint !== undefined && (obj.lazyMint = message.lazyMint);
    message.price !== undefined && (obj.price = message.price);
    message.metaTransaction !== undefined &&
      (obj.metaTransaction = message.metaTransaction);
    message.destinationDomain !== undefined &&
      (obj.destinationDomain = message.destinationDomain);
    return obj;
  },

  fromPartial(
    object: DeepPartial<MsgSendCrossMintTrusted>
...
export const MsgSendCrossMintTrustedResponse = {
  ...
  decode(
    input: Reader | Uint8Array,
    length?: number
  ): MsgSendCrossMintTrustedResponse {
    const reader = input instanceof Uint8Array ? new Reader(input) : input;
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = {
      ...baseMsgSendCrossMintTrustedResponse,
    } as MsgSendCrossMintTrustedResponse;
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
  ...
  fromPartial(
    object: DeepPartial<MsgSendCrossMintTrustedResponse>
  ): MsgSendCrossMintTrustedResponse {
    const message = {
      ...baseMsgSendCrossMintTrustedResponse,
    } as MsgSendCrossMintTrustedResponse;
...
export const MsgMintSwap = {
  ...
  fromJSON(object: any): MsgMintSwap {
    ...
    if (
      object.destinationDenomId !== undefined &&
      object.destinationDenomId !== null
    ) {
  ...
  toJSON(message: MsgMintSwap): unknown {
    ...
    message.recipient !== undefined && (obj.recipient = message.recipient);
    message.didOwner !== undefined && (obj.didOwner = message.didOwner);
    message.destinationDenomId !== undefined &&
      (obj.destinationDenomId = message.destinationDenomId);
    message.price !== undefined && (obj.price = message.price);
    message.r !== undefined && (obj.r = message.r);
    message.s !== undefined && (obj.s = message.s);
    message.v !== undefined && (obj.v = message.v);
...
export const MsgInitiateSwapResponse = {
  ...
  decode(input: Reader | Uint8Array, length?: number): MsgInitiateSwapResponse {
    ...
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = {
      ...baseMsgInitiateSwapResponse,
    } as MsgInitiateSwapResponse;
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
  ...
  fromPartial(
    object: DeepPartial<MsgInitiateSwapResponse>
  ): MsgInitiateSwapResponse {
    const message = {
      ...baseMsgInitiateSwapResponse,
    } as MsgInitiateSwapResponse;
    if (object.relayTo !== undefined && object.relayTo !== null) {
...
export const MsgMintTrustedResource = {
  ...
  fromJSON(object: any): MsgMintTrustedResource {
    ...
    if (
      object.resourceWhitelistAccess !== undefined &&
      object.resourceWhitelistAccess !== null
    ) {
    ...
    if (
      object.resourceLocation !== undefined &&
  ...
  toJSON(message: MsgMintTrustedResource): unknown {
    ...
    if (message.resourceWhitelistAccess) {
      obj.resourceWhitelistAccess = message.resourceWhitelistAccess.map(
        (e) => e
      );
    } else {
      obj.resourceWhitelistAccess = [];
    }
    message.resourceLocation !== undefined &&
      (obj.resourceLocation = message.resourceLocation);
    message.lazyMint !== undefined && (obj.lazyMint = message.lazyMint);
    message.price !== undefined && (obj.price = message.price);
    message.r !== undefined && (obj.r = message.r);
    message.s !== undefined && (obj.s = message.s);
  ...
  fromPartial(
    object: DeepPartial<MsgMintTrustedResource>
  ): MsgMintTrustedResource {
    const message = { ...baseMsgMintTrustedResource } as MsgMintTrustedResource;
    message.resourceWhitelistAccess = [];
    if (object.creator !== undefined && object.creator !== null) {
      message.creator = object.creator;
...
export const MsgMintTrustedResourceResponse = {
  ...
  decode(
    input: Reader | Uint8Array,
    length?: number
  ): MsgMintTrustedResourceResponse {
    const reader = input instanceof Uint8Array ? new Reader(input) : input;
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = {
      ...baseMsgMintTrustedResourceResponse,
    } as MsgMintTrustedResourceResponse;
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
  ...
  fromPartial(
    object: DeepPartial<MsgMintTrustedResourceResponse>
  ): MsgMintTrustedResourceResponse {
    const message = {
      ...baseMsgMintTrustedResourceResponse,
    } as MsgMintTrustedResourceResponse;
...
const baseMsgRoyaltyInfo: object = {
  creator: "",
  id: "",
  receiver: "",
...
export const MsgRoyaltyInfo = {
  ...
  fromJSON(object: any): MsgRoyaltyInfo {
    ...
    if (
      object.royaltyFeePercentage !== undefined &&
      object.royaltyFeePercentage !== null
    ) {
  ...
  toJSON(message: MsgRoyaltyInfo): unknown {
    ...
    message.royaltyFeePercentage !== undefined &&
      (obj.royaltyFeePercentage = message.royaltyFeePercentage);
    message.metadataRef !== undefined &&
      (obj.metadataRef = message.metadataRef);
    message.denomId !== undefined && (obj.denomId = message.denomId);
    return obj;
...
const baseMsgRoyaltyInfoResponse: object = {
  receiver: "",
  royaltyFeePercentage: 0,
  metadataRef: "",
};
...
export const MsgRoyaltyInfoResponse = {
  ...
  fromPartial(
    object: DeepPartial<MsgRoyaltyInfoResponse>
  ): MsgRoyaltyInfoResponse {
    const message = { ...baseMsgRoyaltyInfoResponse } as MsgRoyaltyInfoResponse;
    if (object.receiver !== undefined && object.receiver !== null) {
      message.receiver = object.receiver;
...
export const MsgChangeOwnerResponse = {
  ...
  toJSON(message: MsgChangeOwnerResponse): unknown {
    const obj: any = {};
    message.didIdentity !== undefined &&
      (obj.didIdentity = message.didIdentity);
    message.owner !== undefined && (obj.owner = message.owner);
    message.previousChange !== undefined &&
      (obj.previousChange = message.previousChange);
    return obj;
  },
...
const baseMsgGrantDelegate: object = {
  delegate: "",
  delegateType: "",
  validity: 0,
  creator: "",
...
export const MsgGrantDelegate = {
  ...
  toJSON(message: MsgGrantDelegate): unknown {
    ...
    message.delegateType !== undefined &&
      (obj.delegateType = message.delegateType);
...
export const MsgGrantDelegateResponse = {
  ...
  decode(
    input: Reader | Uint8Array,
    length?: number
  ): MsgGrantDelegateResponse {
    const reader = input instanceof Uint8Array ? new Reader(input) : input;
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = {
      ...baseMsgGrantDelegateResponse,
    } as MsgGrantDelegateResponse;
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
  ...
  fromPartial(
    object: DeepPartial<MsgGrantDelegateResponse>
  ): MsgGrantDelegateResponse {
    const message = {
      ...baseMsgGrantDelegateResponse,
    } as MsgGrantDelegateResponse;
...
export const MsgRevokeDelegateResponse = {
  ...
  decode(
    input: Reader | Uint8Array,
    length?: number
  ): MsgRevokeDelegateResponse {
    const reader = input instanceof Uint8Array ? new Reader(input) : input;
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = {
      ...baseMsgRevokeDelegateResponse,
    } as MsgRevokeDelegateResponse;
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
  ...
  fromPartial(
    object: DeepPartial<MsgRevokeDelegateResponse>
  ): MsgRevokeDelegateResponse {
    const message = {
      ...baseMsgRevokeDelegateResponse,
    } as MsgRevokeDelegateResponse;
...
export const MsgSetAttributeResponse = {
  ...
  decode(input: Reader | Uint8Array, length?: number): MsgSetAttributeResponse {
    ...
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = {
      ...baseMsgSetAttributeResponse,
    } as MsgSetAttributeResponse;
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
  ...
  fromPartial(
    object: DeepPartial<MsgSetAttributeResponse>
  ): MsgSetAttributeResponse {
    const message = {
      ...baseMsgSetAttributeResponse,
    } as MsgSetAttributeResponse;
    if (object.ok !== undefined && object.ok !== null) {
...
const baseMsgRevokeAttribute: object = {
  didIdentity: "",
  actor: "",
  creator: "",
};
...
export const MsgRevokeAttributeResponse = {
  ...
  decode(
    input: Reader | Uint8Array,
    length?: number
  ): MsgRevokeAttributeResponse {
    const reader = input instanceof Uint8Array ? new Reader(input) : input;
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = {
      ...baseMsgRevokeAttributeResponse,
    } as MsgRevokeAttributeResponse;
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
  ...
  fromPartial(
    object: DeepPartial<MsgRevokeAttributeResponse>
  ): MsgRevokeAttributeResponse {
    const message = {
      ...baseMsgRevokeAttributeResponse,
    } as MsgRevokeAttributeResponse;
...
export const MsgTransferDenomResponse = {
  ...
  fromPartial(
    _: DeepPartial<MsgTransferDenomResponse>
  ): MsgTransferDenomResponse {
    const message = {
      ...baseMsgTransferDenomResponse,
    } as MsgTransferDenomResponse;
...
export const MsgFileMetadataResponse = {
  ...
  decode(input: Reader | Uint8Array, length?: number): MsgFileMetadataResponse {
    ...
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = {
      ...baseMsgFileMetadataResponse,
    } as MsgFileMetadataResponse;
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
  ...
  fromPartial(
    object: DeepPartial<MsgFileMetadataResponse>
  ): MsgFileMetadataResponse {
    const message = {
      ...baseMsgFileMetadataResponse,
    } as MsgFileMetadataResponse;
    if (object.hash !== undefined && object.hash !== null) {
...
export const MsgMetadata = {
  ...
  fromJSON(object: any): MsgMetadata {
    ...
    if (
      object.additionalSources !== undefined &&
      object.additionalSources !== null
    ) {
    ...
    if (
      object.verifiedCredentialRef !== undefined &&
      object.verifiedCredentialRef !== null
    ) {
    ...
    if (
      object.enableIpldForestAccess !== undefined &&
      object.enableIpldForestAccess !== null
    ) {
  ...
  toJSON(message: MsgMetadata): unknown {
    ...
    message.verifiedCredentialRef !== undefined &&
      (obj.verifiedCredentialRef = message.verifiedCredentialRef);
    message.did !== undefined && (obj.did = message.did);
    message.from !== undefined && (obj.from = message.from);
    message.enableIpldForestAccess !== undefined &&
      (obj.enableIpldForestAccess = message.enableIpldForestAccess);
...
export const MsgSendMetadataOwnership = {
  ...
  decode(
    ...
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = {
      ...baseMsgSendMetadataOwnership,
    } as MsgSendMetadataOwnership;
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
  ...
  toJSON(message: MsgSendMetadataOwnership): unknown {
    ...
    message.data !== undefined &&
      (obj.data = message.data
        ? AguaclaraPacketData.toJSON(message.data)
        : undefined);
    return obj;
  },

  fromPartial(
    object: DeepPartial<MsgSendMetadataOwnership>
  ): MsgSendMetadataOwnership {
    const message = {
      ...baseMsgSendMetadataOwnership,
    } as MsgSendMetadataOwnership;
...
export const MsgSendMetadataOwnershipResponse = {
  ...
  decode(
    ...
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = {
      ...baseMsgSendMetadataOwnershipResponse,
    } as MsgSendMetadataOwnershipResponse;
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
  ...
  fromPartial(
    object: DeepPartial<MsgSendMetadataOwnershipResponse>
  ): MsgSendMetadataOwnershipResponse {
    const message = {
      ...baseMsgSendMetadataOwnershipResponse,
    } as MsgSendMetadataOwnershipResponse;
...
export const AguaclaraPacketData = {
  ...
  toJSON(message: AguaclaraPacketData): unknown {
    ...
    message.tokenAddress !== undefined &&
      (obj.tokenAddress = message.tokenAddress);
    message.tokenId !== undefined && (obj.tokenId = message.tokenId);
    message.didRecipient !== undefined &&
      (obj.didRecipient = message.didRecipient);
...
export interface Msg {
  ...
  RemoveDataSource(
    request: MsgRemoveDataSource
  ): Promise<MsgRemoveDataSourceResponse>;
  UpdateDataSource(
    request: MsgUpdateDataSource
  ): Promise<MsgUpdateDataSourceResponse>;
  AddDataUnion(request: MsgAddDataUnion): Promise<MsgAddDataUnionResponse>;
  RemoveDataUnion(
    request: MsgRemoveDataUnion
  ): Promise<MsgRemoveDataUnionResponse>;
  UpdateDataUnion(
    request: MsgUpdateDataUnion
  ): Promise<MsgUpdateDataUnionResponse>;
  /** Send cross chain message */
  SendMetadataOwnership(
    request: MsgSendMetadataOwnership
  ): Promise<MsgSendMetadataOwnershipResponse>;
  /** CreateDid */
   ...
   */
  RevokeDelegate(
    request: MsgRevokeDelegate
  ): Promise<MsgRevokeDelegateResponse>;
  /** GrantDelegate */
  ...
  /** RevokeAttribute */
  RevokeAttribute(
    request: MsgRevokeAttribute
  ): Promise<MsgRevokeAttributeResponse>;
  /** Metadata */
  ...
  MintTrustedContent(
    request: MsgMintTrustedContent
  ): Promise<MsgMintTrustedContentResponse>;
  /** MintTrustedResource defines a method for minting a resource. */
  MintTrustedResource(
    request: MsgMintTrustedResource
  ): Promise<MsgMintTrustedResourceResponse>;
  /** Create ancon metadata */
  UpdateMetadataOwnership(
    request: MsgUpdateMetadataOwnership
  ): Promise<MsgUpdateMetadataOwnershipResponse>;
}
...
export class MsgClientImpl implements Msg {
  ...
  AddSchemaStore(request: MsgSchemaStore): Promise<MsgSchemaStoreResponse> {
    ...
    const promise = this.rpc.request(
      "ElectronicSignaturesIndustries.anconprotocol.anconprotocol.Msg",
      "AddSchemaStore",
      data
    );
    return promise.then((data) =>
      MsgSchemaStoreResponse.decode(new Reader(data))
    );
  }
  ...
  AddDataSource(request: MsgAddDataSource): Promise<MsgAddDataSourceResponse> {
    ...
    return promise.then((data) =>
      MsgAddDataSourceResponse.decode(new Reader(data))
    );
  }
  ...
  RemoveDataSource(
    ...
    return promise.then((data) =>
      MsgRemoveDataSourceResponse.decode(new Reader(data))
    );
  }
  ...
  UpdateDataSource(
    ...
    return promise.then((data) =>
      MsgUpdateDataSourceResponse.decode(new Reader(data))
    );
  }
  ...
  AddDataUnion(request: MsgAddDataUnion): Promise<MsgAddDataUnionResponse> {
    ...
    return promise.then((data) =>
      MsgAddDataUnionResponse.decode(new Reader(data))
    );
  }
  ...
  RemoveDataUnion(
    ...
    return promise.then((data) =>
      MsgRemoveDataUnionResponse.decode(new Reader(data))
    );
  }
  ...
  UpdateDataUnion(
    ...
    return promise.then((data) =>
      MsgUpdateDataUnionResponse.decode(new Reader(data))
    );
  }
  ...
  SendMetadataOwnership(
    ...
    return promise.then((data) =>
      MsgSendMetadataOwnershipResponse.decode(new Reader(data))
    );
  }
  ...
  RevokeDid(request: MsgRevokeDid): Promise<MsgRevokeDidResponse> {
    ...
    return promise.then((data) =>
      MsgRevokeDidResponse.decode(new Reader(data))
    );
  }
  ...
  RoyaltyInfo(request: MsgRoyaltyInfo): Promise<MsgRoyaltyInfoResponse> {
    ...
    return promise.then((data) =>
      MsgRoyaltyInfoResponse.decode(new Reader(data))
    );
  }
  ...
  RevokeDelegate(
    ...
    return promise.then((data) =>
      MsgRevokeDelegateResponse.decode(new Reader(data))
    );
  }
  ...
  GrantDelegate(request: MsgGrantDelegate): Promise<MsgGrantDelegateResponse> {
    ...
    return promise.then((data) =>
      MsgGrantDelegateResponse.decode(new Reader(data))
    );
  }
  ...
  GrantAttribute(request: MsgSetAttribute): Promise<MsgSetAttributeResponse> {
    ...
    return promise.then((data) =>
      MsgSetAttributeResponse.decode(new Reader(data))
    );
  }
  ...
  RevokeAttribute(
    ...
    return promise.then((data) =>
      MsgRevokeAttributeResponse.decode(new Reader(data))
    );
  }
  ...
  IssueDenom(request: MsgIssueDenom): Promise<MsgIssueDenomResponse> {
    ...
    return promise.then((data) =>
      MsgIssueDenomResponse.decode(new Reader(data))
    );
  }
  ...
  MintTrustedContent(
    ...
    return promise.then((data) =>
      MsgMintTrustedContentResponse.decode(new Reader(data))
    );
  }
  ...
  MintTrustedResource(
    ...
    return promise.then((data) =>
      MsgMintTrustedResourceResponse.decode(new Reader(data))
    );
  }
  ...
  UpdateMetadataOwnership(
    ...
    return promise.then((data) =>
      MsgUpdateMetadataOwnershipResponse.decode(new Reader(data))
    );
  }
}
