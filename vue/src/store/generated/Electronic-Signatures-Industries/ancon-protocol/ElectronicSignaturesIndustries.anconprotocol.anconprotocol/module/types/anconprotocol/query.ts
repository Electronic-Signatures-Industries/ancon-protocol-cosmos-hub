...
export const QuerySchemaStoreRequest = {
  ...
  decode(input: Reader | Uint8Array, length?: number): QuerySchemaStoreRequest {
    ...
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = {
      ...baseQuerySchemaStoreRequest,
    } as QuerySchemaStoreRequest;
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
  ...
  fromPartial(
    object: DeepPartial<QuerySchemaStoreRequest>
  ): QuerySchemaStoreRequest {
    const message = {
      ...baseQuerySchemaStoreRequest,
    } as QuerySchemaStoreRequest;
    if (object.cid !== undefined && object.cid !== null) {
...
export const QuerySchemaStoreResponse = {
  ...
  decode(
    ...
    length?: number
  ): QuerySchemaStoreResponse {
    const reader = input instanceof Uint8Array ? new Reader(input) : input;
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = {
      ...baseQuerySchemaStoreResponse,
    } as QuerySchemaStoreResponse;
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
  ...
  fromPartial(
    object: DeepPartial<QuerySchemaStoreResponse>
  ): QuerySchemaStoreResponse {
    const message = {
      ...baseQuerySchemaStoreResponse,
    } as QuerySchemaStoreResponse;
...
export const QueryProofMetadataRequest = {
  ...
  decode(
    input: Reader | Uint8Array,
    length?: number
  ): QueryProofMetadataRequest {
    const reader = input instanceof Uint8Array ? new Reader(input) : input;
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = {
      ...baseQueryProofMetadataRequest,
    } as QueryProofMetadataRequest;
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
  ...
  fromPartial(
    object: DeepPartial<QueryProofMetadataRequest>
  ): QueryProofMetadataRequest {
    const message = {
      ...baseQueryProofMetadataRequest,
    } as QueryProofMetadataRequest;
...
const baseQueryReadRoyaltyInfoResponse: object = {
  receiver: "",
  royaltyAmount: 0,
};
...
export const QueryReadRoyaltyInfoResponse = {
  ...
  decode(
    input: Reader | Uint8Array,
    length?: number
  ): QueryReadRoyaltyInfoResponse {
    const reader = input instanceof Uint8Array ? new Reader(input) : input;
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = {
      ...baseQueryReadRoyaltyInfoResponse,
    } as QueryReadRoyaltyInfoResponse;
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
  ...
  toJSON(message: QueryReadRoyaltyInfoResponse): unknown {
    ...
    message.royaltyAmount !== undefined &&
      (obj.royaltyAmount = message.royaltyAmount);
    return obj;
  },

  fromPartial(
    object: DeepPartial<QueryReadRoyaltyInfoResponse>
  ): QueryReadRoyaltyInfoResponse {
    const message = {
      ...baseQueryReadRoyaltyInfoResponse,
    } as QueryReadRoyaltyInfoResponse;
...
export const QueryGetDelegateRequest = {
  ...
  decode(input: Reader | Uint8Array, length?: number): QueryGetDelegateRequest {
    ...
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = {
      ...baseQueryGetDelegateRequest,
    } as QueryGetDelegateRequest;
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
  ...
  fromPartial(
    object: DeepPartial<QueryGetDelegateRequest>
  ): QueryGetDelegateRequest {
    const message = {
      ...baseQueryGetDelegateRequest,
    } as QueryGetDelegateRequest;
    if (object.id !== undefined && object.id !== null) {
...
export const QueryGetDelegateResponse = {
  ...
  decode(
    input: Reader | Uint8Array,
    length?: number
  ): QueryGetDelegateResponse {
    const reader = input instanceof Uint8Array ? new Reader(input) : input;
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = {
      ...baseQueryGetDelegateResponse,
    } as QueryGetDelegateResponse;
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
  ...
  fromPartial(
    object: DeepPartial<QueryGetDelegateResponse>
  ): QueryGetDelegateResponse {
    const message = {
      ...baseQueryGetDelegateResponse,
    } as QueryGetDelegateResponse;
...
export const QueryGetAttributesResponse = {
  ...
  decode(
    input: Reader | Uint8Array,
    length?: number
  ): QueryGetAttributesResponse {
    const reader = input instanceof Uint8Array ? new Reader(input) : input;
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = {
      ...baseQueryGetAttributesResponse,
    } as QueryGetAttributesResponse;
    message.name = [];
    message.value = [];
    while (reader.pos < end) {
      const tag = reader.uint32();
  ...
  fromPartial(
    object: DeepPartial<QueryGetAttributesResponse>
  ): QueryGetAttributesResponse {
    const message = {
      ...baseQueryGetAttributesResponse,
    } as QueryGetAttributesResponse;
...
export const QueryIdentifyOwnerResponse = {
  ...
  decode(
    input: Reader | Uint8Array,
    length?: number
  ): QueryIdentifyOwnerResponse {
    const reader = input instanceof Uint8Array ? new Reader(input) : input;
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = {
      ...baseQueryIdentifyOwnerResponse,
    } as QueryIdentifyOwnerResponse;
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        default:
  ...
  fromPartial(
    _: DeepPartial<QueryIdentifyOwnerResponse>
  ): QueryIdentifyOwnerResponse {
    const message = {
      ...baseQueryIdentifyOwnerResponse,
    } as QueryIdentifyOwnerResponse;
...
export const QueryGetAttributesRequest = {
  ...
  decode(
    input: Reader | Uint8Array,
    length?: number
  ): QueryGetAttributesRequest {
    const reader = input instanceof Uint8Array ? new Reader(input) : input;
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = {
      ...baseQueryGetAttributesRequest,
    } as QueryGetAttributesRequest;
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
  ...
  fromPartial(
    object: DeepPartial<QueryGetAttributesRequest>
  ): QueryGetAttributesRequest {
    const message = {
      ...baseQueryGetAttributesRequest,
    } as QueryGetAttributesRequest;
...
export const QueryIdentifyOwnerRequest = {
  ...
  decode(
    input: Reader | Uint8Array,
    length?: number
  ): QueryIdentifyOwnerRequest {
    const reader = input instanceof Uint8Array ? new Reader(input) : input;
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = {
      ...baseQueryIdentifyOwnerRequest,
    } as QueryIdentifyOwnerRequest;
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
  ...
  fromPartial(
    object: DeepPartial<QueryIdentifyOwnerRequest>
  ): QueryIdentifyOwnerRequest {
    const message = {
      ...baseQueryIdentifyOwnerRequest,
    } as QueryIdentifyOwnerRequest;
...
export const QueryResourceResponse = {
  ...
  fromPartial(
    object: DeepPartial<QueryResourceResponse>
...
export interface Query {
  /** ReadRoyaltyInfo */
  ReadRoyaltyInfo(
    request: QueryReadRoyaltyInfo
  ): Promise<QueryReadRoyaltyInfoResponse>;
  /** Queries a list of resource items. */
  ReadWithPath(request: QueryResourceRequest): Promise<QueryResourceResponse>;
  /** Reads metadata proofs */
  ReadMetadataProof(
    request: QueryProofMetadataRequest
  ): Promise<QueryProofResponse>;
  /** Queries a list of owners items. */
  IdentifyOwner(
    request: QueryIdentifyOwnerRequest
  ): Promise<QueryIdentifyOwnerResponse>;
  /** Queries a list of Attributes items. */
  GetAttributes(
    request: QueryGetAttributesRequest
  ): Promise<QueryGetAttributesResponse>;
  /** Queries a list of resource items. */
  Resource(request: QueryResourceRequest): Promise<QueryResourceResponse>;
  /** Queries a list of delegates items. */
  ReadDelegate(
    request: QueryGetDelegateRequest
  ): Promise<QueryGetDelegateResponse>;
  ...
  ReadSchemaStoreResource(
    request: QuerySchemaStoreRequest
  ): Promise<QuerySchemaStoreResponse>;
}
...
export class QueryClientImpl implements Query {
  ...
  ReadRoyaltyInfo(
    ...
    const promise = this.rpc.request(
      "ElectronicSignaturesIndustries.anconprotocol.anconprotocol.Query",
      "ReadRoyaltyInfo",
      data
    );
    return promise.then((data) =>
      QueryReadRoyaltyInfoResponse.decode(new Reader(data))
    );
  }
  ...
  ReadWithPath(request: QueryResourceRequest): Promise<QueryResourceResponse> {
    ...
    return promise.then((data) =>
      QueryResourceResponse.decode(new Reader(data))
    );
  }
  ...
  IdentifyOwner(
    ...
    return promise.then((data) =>
      QueryIdentifyOwnerResponse.decode(new Reader(data))
    );
  }
  ...
  GetAttributes(
    ...
    return promise.then((data) =>
      QueryGetAttributesResponse.decode(new Reader(data))
    );
  }
  ...
  ReadDelegate(
    ...
    return promise.then((data) =>
      QueryGetDelegateResponse.decode(new Reader(data))
    );
  }
  ...
  ReadSchemaStoreResource(
    ...
    return promise.then((data) =>
      QuerySchemaStoreResponse.decode(new Reader(data))
    );
  }
}
