...
export const QueryReadDidKeyRequest = {
  ...
  fromPartial(
    object: DeepPartial<QueryReadDidKeyRequest>
  ): QueryReadDidKeyRequest {
    const message = { ...baseQueryReadDidKeyRequest } as QueryReadDidKeyRequest;
    if (object.name !== undefined && object.name !== null) {
      message.name = object.name;
    } else {
...
export const QueryReadDidKeyResponse = {
  ...
  decode(input: Reader | Uint8Array, length?: number): QueryReadDidKeyResponse {
    ...
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = {
      ...baseQueryReadDidKeyResponse,
    } as QueryReadDidKeyResponse;
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        default:
  ...
  fromPartial(
    _: DeepPartial<QueryReadDidKeyResponse>
  ): QueryReadDidKeyResponse {
    const message = {
      ...baseQueryReadDidKeyResponse,
    } as QueryReadDidKeyResponse;
    return message;
...
export const QueryGetDelegateResponse = {
  ...
  fromPartial(
    _: DeepPartial<QueryGetDelegateResponse>
  ): QueryGetDelegateResponse {
    const message = {
      ...baseQueryGetDelegateResponse,
    } as QueryGetDelegateResponse;
...
export const QueryGetAttributesResponse = {
  ...
  fromPartial(
    _: DeepPartial<QueryGetAttributesResponse>
  ): QueryGetAttributesResponse {
    const message = {
      ...baseQueryGetAttributesResponse,
    } as QueryGetAttributesResponse;
