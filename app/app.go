...
var (
	...
	// https://github.com/cosmos/gaia/v6/blob/02a54d33ff2c064f3539ae12d75d027d9c665f05/x/wasm/internal/types/proposal.go#L28-L34
...
func NewGaiaApp(
	...
	if loadLatest {
		...
		if err := app.WasmKeeper.InitializePinnedCodes(context.Background()); err != nil {
			panic(err)
		}
	}
